...
$faqs = [
    [
        ...
        'q_de' => 'Wie schnell antworten Sie auf meine Nachricht?',
        'a_de' => 'In der Regel antworten wir innerhalb eines Werktags. Wenn Sie ein Gespräch buchen, bestätigen wir einen Termin, der zu Ihrem Zeitplan und Ihrer Zeitzone passt.',
    ],
    [
        ...
        'q_de' => 'Was sollte ich in meiner ersten Nachricht angeben?',
        'a_de' => 'Eine kurze Beschreibung Ihres Projekts, die Art der benötigten Visuals, Referenzen oder Dateien, falls vorhanden, sowie Ihren Zeitrahmen. Damit bereiten wir einen klaren nächsten Schritt vor.',
    ],
    [
        ...
        'q_de' => 'Arbeiten Sie mit internationalen und Remote-Kunden?',
        'a_de' => 'Ja. Wir arbeiten weltweit mit Marken, Entwicklern und Agenturen und richten unseren Zeitplan nach Ihrer Zeitzone aus, damit die Kommunikation schnell bleibt.',
    ],
    [
        ...
        'q_de' => 'In welchen Sprachen kann ich Sie kontaktieren?',
        'a_de' => 'Sie können uns auf Deutsch oder Englisch schreiben. Die Projektkommunikation läuft in der Sprache weiter, die für Ihr Team am besten funktioniert.',
    ],
    [
        ...
        'q_de' => 'Kann ich ein Gespräch buchen, um mein Projekt zu besprechen?',
        'a_de' => 'Natürlich. Nutzen Sie den Button „Beratung buchen“ und wählen Sie einen Termin. Wir sehen uns Ihr Briefing vorab an, damit sich das Gespräch auf Ihre Ziele konzentriert.',
    ],
    [
        ...
        'q_de' => 'Was passiert, nachdem ich Kontakt aufgenommen habe?',
        'a_de' => 'Wir prüfen Ihre Anfrage, stellen alle nötigen Rückfragen und schlagen Umfang, Zeitplan und einen ersten Vorschau-Plan vor, damit Sie genau wissen, wie das Projekt startet.',
    ],
];
?>
<section class="faq">
