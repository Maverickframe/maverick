...
$ctaTitle = ($mfs_not_en ? '' : get_field('blog_cta_title')) ?: mfs_t('Turn Ideas Into Visual Stories', 'Convierte ideas en historias visuales');
...
$ctaBtnTitle = (!$mfs_not_en && isset($ctaButton['title']) && $ctaButton['title']) ? $ctaButton['title'] : mfs_t('Book a call', 'Reserva una llamada');
