...
$ctaText = ($mfs_not_en ? '' : get_field('blog_cta_text')) ?: mfs_t('Whether you’re planning a product launch, marketing campaign, or real estate project, high-quality CGI helps communicate ideas clearly and accelerate decision-making. Our team creates photorealistic visuals used in marketing, presentations, and pre-sales worldwide.', 'Ya sea que planifiques el lanzamiento de un producto, una campaña de marketing o un proyecto inmobiliario, el CGI de alta calidad ayuda a comunicar ideas con claridad y acelerar la toma de decisiones. Nuestro equipo crea visuales fotorrealistas usados en marketing, presentaciones y preventas en todo el mundo.', 'Ob du einen Produktlaunch, eine Marketingkampagne oder ein Immobilienprojekt planst — hochwertiges CGI hilft, Ideen klar zu vermitteln und Entscheidungen zu beschleunigen. Unser Team erstellt fotorealistische Visuals, die weltweit in Marketing, Präsentationen und im Pre-Sales eingesetzt werden.');
