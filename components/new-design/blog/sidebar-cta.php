...
$fallback = [
    ...
    ['eyebrow' => mfs_t('RESOURCE', 'RECURSO', 'RESSOURCE'),     'head' => mfs_t('Get our project brief template', 'Consigue nuestra plantilla de brief de proyecto', 'Holen Sie sich unsere Projekt-Brief-Vorlage'),             'sub' => mfs_t('A one-pager we use to scope CGI projects — scope, deliverables, milestones.', 'Una página que usamos para planificar proyectos CGI: alcance, entregables, hitos.', 'Ein Onepager, mit dem wir CGI-Projekte planen — Umfang, Ergebnisse, Meilensteine.'), 'label' => mfs_t('Download PDF', 'Descargar PDF', 'PDF herunterladen'),        'url' => home_url('/contacts/'),  'modal' => false],
    ['eyebrow' => mfs_t('SOCIAL PROOF', 'PRUEBA SOCIAL', 'SOCIAL PROOF'), 'head' => mfs_t('300+ teams trust Maverick Frame', 'Más de 300 equipos confían en Maverick Frame', 'Über 300 Teams vertrauen Maverick Frame'),            'sub' => mfs_t('See how our visuals helped brands and developers sell faster.', 'Mira cómo nuestros visuales ayudaron a marcas y promotores a vender más rápido.', 'Sehen Sie, wie unsere Visuals Marken und Entwicklern geholfen haben, schneller zu verkaufen.'),               'label' => mfs_t('Read case studies', 'Leer casos de éxito', 'Fallstudien lesen'),   'url' => $mfs_lang === 'es' ? home_url('/es/casos-de-exito/') : ( $mfs_lang === 'de' ? home_url('/de/referenzen/') : home_url('/success-stories/') ), 'modal' => false],
    ['eyebrow' => mfs_t('TALK TO US', 'HABLEMOS', 'SPRICH MIT UNS'),   'head' => mfs_t('Working on a project like this?', '¿Trabajas en un proyecto como este?', 'Arbeiten Sie an einem ähnlichen Projekt?'),            'sub' => mfs_t('Free 15-min consultation. No commitment — just a quick chat about your project.', 'Consulta gratuita de 15 min. Sin compromiso: solo una charla rápida sobre tu proyecto.', 'Kostenlose 15-minütige Beratung. Unverbindlich — einfach ein kurzes Gespräch über Ihr Projekt.'), 'label' => mfs_t('Book a 15-min call', 'Reserva una llamada de 15 min', '15-Min-Gespräch buchen'), 'url' => '#book', 'modal' => true],
];
