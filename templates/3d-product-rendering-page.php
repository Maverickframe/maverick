<?php
/*
* Template Name: 3D Product Rendering Page
...
<article>
    ...
    <div class="container">
        ...
        <?php echo get_template_part( 'components/animation-worldwide', null, [
            'classes' => 'square-mobile'
        ] ); ?>
    </div>

    <?php echo get_template_part( 'components/service-page/solutions', null, array(
        'classes' => 'darken',
    ) ); ?> 
    ...
    <?php echo get_template_part( 'components/service-page/why-choose', null, array(
        'classes' => 'darken',
    ) ); ?> 
